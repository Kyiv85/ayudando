  ...
  <!-- Page Content -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-sm-6">
                    ...
                    <h2 class="section-heading">Venezolanos en Argentina</h2>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-5 col-sm-6">
                    <hr class="section-heading-spacer">
                    <div class="clearfix"></div>
                    <h2 class="section-heading">¿Cuál es la idea?</h2>
    ...
    <div class="banner">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-5">
                    <h2>Contáctanos en las redes sociales. ¡Tu ayuda cuenta!</h2>
                </div>
                <div class="col-lg-7">
